...
const SignUp = () => {
  return <div className='flex flex-col items-centre justify-center min-w-96 mx-auto'>
     ...
     <h1 className='text-3xl font-semibold text-center text-gray-300'>Sign Up
          ...
          <form>
            <div>
              ...
              <input type='text' placeholder='Shubham Gupta' className='w-full input input-bordered h-10' />
            </div>
            <div>
            <label className='label p-2'>
                <span className='text-base label-text'>Username</span>
                </label>
                <input type='text' placeholder='Shubham' className='w-full input input-bordered h-10' />
